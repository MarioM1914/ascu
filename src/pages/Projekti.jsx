      ...
      <div className="w-full h-screen">
        ...
        <div class="p-2 rounded-lg">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="flex flex-col items-center bg-rose-100 rounded-lg w-full max-w-sm mx-auto">
            ...
            <div class="flex flex-col items-center bg-blue-100 rounded-lg w-full max-w-sm mx-auto">
              <div class="w-[96%] h-40 rounded-lg overflow-hidden mt-1.5">
                <img
            ...
            <div class="flex flex-col items-center bg-green-100 rounded-lg w-full max-w-sm mx-auto">
              <div class="w-[96%] h-40 rounded-lg overflow-hidden mt-1.5">
                <img
              ...
              <p class="text-sm text-center text-gray-700 leading-loose mt-4">
                * Projekt namijenjen već iskusnim jedriličarima i ambicioznim
                “školarcima” s ciljem postizanja što boljih sportskih rezultata
                na regatama diljem Jadrana i šire.
              </p>
            </div>

            <div class="flex flex-col items-center bg-red-100 rounded-lg w-full max-w-sm mx-auto">
              <div class="w-[96%] h-40 rounded-lg overflow-hidden mt-1.5">
                <img
                  src="/assets/dita.jpg"
                  alt="Đita image"
          ...
          <div className="flex justify-center items-center bg-blue-100 rounded-lg p-4 mt-8">
